//I need computer to make a choice
//I need user to make a choice
//capture user choices
//compare user choices to computer generated choice
//display results to user

var words = ['howl','grave','haunted','ghoulish','costume','cauldron','phantom','zombie'];
...
function startGame() {
  ...
  // Solution is chosen randomly from words.
